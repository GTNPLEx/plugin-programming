...
const BlogContent = () => {
  ...
  const handleRunCode = () => {
    if (typeof window !== 'undefined') {
      ...
      console.log("Cannot open new window in a non-browser environment");
    }
  };
  ...
  return (
    <div className={styles['blog-container']}>
      ...
      <div className={styles['blog-content']}>
        ...
        <p>
          Define the plugin interface in C++:
        </p>
        <SyntaxHighlighter language="cpp" style={atomDark}>
          {`// Plugin interface for a VCA (Voltage Controlled Amplifier) plugin
class VCAPlugin {
  public:
