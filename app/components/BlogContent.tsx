...
const BlogContent = () => {
  const codeRef = useRef<SyntaxHighlighter | null>(null);
  const [isCopied, setIsCopied] = useState(false);


  const handleCopyClick = () => {
    const code = codeRef.current?.props.children as string;
  ...
  return (
    <div className={styles['blog-container']}>
      ...
      <div className={styles['blog-content']}>
        ...
        <p>
          Create an input field: <input type="text" id="userInput" />
        </p>
        <h2>Step 2: Implement the Plugin Interface</h2>
        <p>
          Implement the plugin interface in C++:
          <SyntaxHighlighter language="cpp" style={atomDark} ref={codeRef}>
